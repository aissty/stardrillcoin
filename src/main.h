...
static const int COINBASE_MATURITY_PPC = 100; // Adapted for Stardrillcoin - same as it is set in Bitcoin, where Peercoin is 500
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 60 * 30; // stardrillcoin: 30 minute block spacing 
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 3; // stardrillcoin: Minimum age for coin age changed to 3 days 
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // stardrillcoin: Stake age of full weight
static const int64 IPO_SHARES = 1000000 * COIN; // stardrillcoin: Total number of SDC to create using proof of work (intented for IPO)
static const int64 PROOF_OF_WORK_BLOCKS = 400; // stardrillcoin: Block height of the last proof of work block
...
public:
    ...
    */
    ...
    /** Amount of stardrillcoin spent by this transaction.
    ...
    /** Amount of stardrillcoin coming in to this transaction
