...
namespace Checkpoints
{
    ...
    // Stardrillcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // Stardrillcoin: get last synchronized checkpoint
    ...
    // Stardrillcoin: only descendant of current sync-checkpoint is allowed
    ...
    // Stardrillcoin: reset synchronized checkpoint to last hardened checkpoint
...
// Stardrillcoin: sync-checkpoint master key
...
// Stardrillcoin: verify signature of sync-checkpoint message
...
// Stardrillcoin: process synchronized checkpoint
