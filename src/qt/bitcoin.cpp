...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. Stardrillcoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], "stardrillcoin:", 11) == 0)
        {
    ...
    app.setOrganizationName("Stardrillcoin");
    app.setOrganizationDomain("stardrillcoin.net");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("Stardrillcoin-Qt-testnet");
    else
        app.setApplicationName("Stardrillcoin-Qt");
