...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm send SDC"),
    ...
    case WalletModel::InvalidAddress:
        QMessageBox::warning(this, tr("Send SDC"),
    ...
    case WalletModel::TransactionCommitFailed:
        QMessageBox::warning(this, tr("Send SDC"),
            tr("Error: The transaction was rejected.  This might happen if some of the SDC in your portfolio were already spent, such as if you used a copy of wallet.dat and SDC were spent in the copy but not marked as spent here."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
