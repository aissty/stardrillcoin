...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("m-SDC");
    case uBTC: return QString::fromUtf8("μ-SDC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("stardrillcoin");
    case mBTC: return QString("Milli-stardrillcoin (1 / 1,000)");
    case uBTC: return QString("Micro-stardrillcoin (1 / 1,000,000)");
    default: return QString("???");
    }
}
