/*
 * Qt4 Stardrillcoin GUI.
 *
 * W.J. van der Laan 2011-2012
 * The Bitcoin Developers 2011-2012
 * The Peercoin Developers 2011-2013
 * The Stardrillcoin Developers 2013-2014
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Stardrillcoin Portfolio"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/stardrillcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive SDC"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(receiveCoinsAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send SDC"), this);
    sendCoinsAction->setToolTip(tr("Send SDC to a Stardrillcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/stardrillcoin"), tr("&About %1").arg(qApp->applicationName()), this);
    aboutAction->setToolTip(tr("Show information about Stardrillcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Stardrillcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/stardrillcoin"), tr("Show/Hide &Stardrillcoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Stardrillcoin window"));
    ...
    exportPeercoinKeysAction->setToolTip(tr("Export the Peercoin keys associated with the Stardrillcoin addresses to Peercoin via RPC"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenu *SDC = appMenuBar->addMenu(tr("S&hares"));
    SDC->addAction(exportPeercoinKeysAction);
	SDC->addAction(distributeDividendsAction);
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/stardrillcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/stardrillcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Stardrillcoin client"));
    ...
    notificator = new Notificator(tr("Stardrillcoin-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide Stardrillcoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Stardrillcoin network", "", count));
}
