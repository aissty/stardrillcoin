...
static unsigned char pchMessageStartTestOld[4] = { 0xd1, 0xe3, 0xf5, 0xf7 };
static unsigned char pchMessageStartTestNew[4] = { 0xc2, 0xf4, 0xc6, 0xe8 };
static unsigned int nMessageStartTestSwitchTime = 1346200000;

// Stardrillcoin message start (switched from Bitcoin's in Peercoin v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf1, 0xb1, 0xb1, 0xd1 };
static unsigned char pchMessageStartStardrillcoin[4] = { 0xe2, 0xe2, 0xe2, 0xe2 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartStardrillcoin : pchMessageStartBitcoin, sizeof(pchMessageStartStardrillcoin));
}
